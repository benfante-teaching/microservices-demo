...
public class PeopleControllerTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        mvc.perform(patch(BASE_PATH + "/{uuid}", uuid).contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {
    ...
    void testDeletePerson() throws Exception {
        String uuid = "00000000-0000-0000-0000-000000000001";
        mvc.perform(delete(BASE_PATH + "/{uuid}", uuid)).andExpect(status().isNoContent());
    }

    @Test
    void testDeletePersonNotFound() throws Exception {
        String uuid = "00000000-0000-0000-0000-000000000999";
        mvc.perform(delete(BASE_PATH + "/{uuid}", uuid)).andExpect(status().isNotFound())
                .andExpect(jsonPath("$.title", is("Not Found")))
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_PROBLEM_JSON));
    }
